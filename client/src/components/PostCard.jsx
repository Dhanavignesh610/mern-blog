    ...
    <div className='w-full dark:border-none h-[346px] overflow-hidden xl:w-[23%] lg:w-[30%] md:w-[47%] sm:w-[30%] transition duration-300 ease-in-out'>
      <Link to={`/post/${post.slug}`}>
        <img
          src={post.image}
          alt='post cover'
          className='h-[160px] hover:opacity-80 w-full rounded object-cover transition-all duration-300 z-20 border border-slate-200 dark:border-slate-700'
        />
      <div className='flex mt-4 flex-col gap-2'>
      <div>
        <p className='text-lg hover:underline text-black dark:text-white font-semibold line-clamp-2' style={{lineHeight:"1.5rem"}}>{post.title}</p>
     </div>
